  ...
  return (
    <div className="font-sans bg-blue-50 min-h-screen flex flex-col items-center p-5 box-border">
      ...
      <main className="max-w-xl w-full p-6 bg-white rounded-md shadow mt-6">
        <h1 className="text-2xl font-bold mb-4">Beach Sweep - Bali</h1>
        <p>Lokasi : Pantai Kuta</p>
        <p>Link Maps : <a href="https://maps.app.goo.gl/4WHmUrwDm2mVXsvT7" className="text-blue-600 underline" target="_blank">Google Maps</a></p>
        <p>Waktu Pelaksanaan : 6:00 WIB - Selesai</p>
