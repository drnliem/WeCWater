  ...
  return (
    <div className="font-sans bg-blue-50 min-h-screen flex flex-col items-center p-5 box-border">
      ...
      <main className="max-w-xl w-full p-6 bg-white rounded-md shadow mt-6">
        <h1 className="text-2xl font-bold mb-4">Mangrove Replanting - Surabaya</h1>
        <p>Lokasi : Taman Mangrove Wonorejo Surabaya</p>
        <p>Link Maps : <a href="https://maps.app.goo.gl/uDf4CHz7HxiGEdem9" className="text-blue-600 underline" target="_blank">Google Maps</a></p>
        <p>Waktu Pelaksanaan : 9:00 WIB - Selesai</p>
