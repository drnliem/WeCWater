...
export const Location = () => {
  return (
    <div className="location" data-model-id="84:184">
      <div className="div">
        ...
        <div className="group-2">
          ...
          <img className="img-2" alt="Location" src={location3} />
        </div>
        ...
        <div className="group-3">
          ...
          <img className="img-2" alt="Location" src={location4} />
        </div>
        ...
        <div className="group-4">
          ...
          <img className="img-2" alt="Location" src={location5} />
        </div>
        ...
        <div className="group-5">
          ...
          <img className="img-2" alt="Location" src={location} />
        </div>
        ...
        <div className="group-6">
          ...
          <img className="img-2" alt="Location" src={location2} />
        </div>
      </div>
    </div>
  );
